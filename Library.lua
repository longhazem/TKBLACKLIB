...
local BaseURL = "https://raw.githubusercontent.com/longhazem/TKBLACKLIB/refs/heads/main/"
...
function Library:ChangeCursorCrossColor(Color: Color3)
    warn("TokaiHub:ChangeCursorCrossColor is deprecated, please use TokaiHub.Cursor:ChangeCrossColor instead.")
    Library.Cursor:ChangeCrossColor(Color)
end

--// DEPRECATED
function Library:ResetCursorCross()
    warn("TokaiHub:ResetCursorCross is deprecated, please use TokaiHub.Cursor:ResetCross instead.")
    Library.Cursor:ResetCross()
end

--// DEPRECATED
function Library:ChangeCursorIcon(ImageId: string)
    warn("TokaiHub:ChangeCursorIcon is deprecated, please use TokaiHub.Cursor:ChangeIcon instead.")
    Library.Cursor:ChangeIcon(ImageId)
end

--// DEPRECATED
function Library:ChangeCursorIconColor(Color: Color3)
    warn("TokaiHub:ChangeCursorIconColor is deprecated, please use TokaiHub.Cursor:ChangeIconColor instead.")
    Library.Cursor:ChangeIconColor(Color)
end

--// DEPRECATED
function Library:ChangeCursorIconSize(Size: UDim2)
    warn("TokaiHub:ChangeCursorIconSize is deprecated, please use TokaiHub.Cursor:ChangeIconSize instead.")
    Library.Cursor:ChangeIconSize(Size)
end

--// DEPRECATED
function Library:ResetCursorIcon()
    warn("TokaiHub:ResetCursorIcon is deprecated, please use TokaiHub.Cursor:ResetIcon instead.")
    Library.Cursor:ResetIcon()
end
